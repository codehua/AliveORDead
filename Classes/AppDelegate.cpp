...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	vector<map<string, string>> vect = DBHelper::GetTable("select Id,Name,Lv,Vip from Player");
	...
	auto textParse = TextParser("game.txt");

	Row row = textParse.getRowById(1);

	log("xxxxxxxxxxxx = %s", row["des"].c_str());
